...
if __name__ == '__main__':
    ...
    argumentoentrada = sys.argv[1]
    argumentosaida = sys.argv[2]

    run("java -jar jar.jar argumentoentrada argumentosaida")
    
    
    #subprocess.call(["./jar.jar", argumentoentrada, argumentosaida])
    ryan_file = argumentosaida
    #ryan_file = 'C:\Users\Wmax\workspace\profilebuilder\nome_do_arquivo.txt'
