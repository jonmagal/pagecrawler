...
public class TesteWebCrawler implements CrawlerListener{
	 ...
	 * @param args
	 */
	public static String entrada_caminho;
	public static void main(String[] args) {
		/*
        for (int i = 0; i < args.length; i++){
            System.out.println(args[i]);
		}*/
        String entrada_site = args[0];
        entrada_caminho = args[1];
		...
		bufferLinks.addFiltro(entrada_site+".*");
	...
	public void processPage(Page page, Link link) {
		...
		try {
	        ...
	        File file = new File(entrada_caminho);
